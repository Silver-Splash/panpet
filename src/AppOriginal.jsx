...
const KpiCard = ({ title, value, sub, icon: Icon, color, trend, trendVal, onClick }) => (
  <div onClick={onClick} style={{
    ...
    <div style={{
      fontSize: 26, fontWeight: 800, color: T.t1, letterSpacing: "-0.02em",
...
const THead = ({ cols }) => (
  <thead>
    <tr style={{ borderBottom: `1px solid ${T.border}` }}>
      {cols.map(c => (
        <th key={c} style={{
          textAlign: "left", padding: "8px 12px", color: T.t3,
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
        ...
        <Card>
          ...
          {transactions.slice(0, 5).map((t, i) => (
            <div key={t.id} style={{
              display: "flex", alignItems: "center", gap: 9, marginBottom: i < 4 ? "10px" : 0,
      ...
      <Card>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
          <input value={search} onChange={e => setSearch(e.target.value)}
            ...
            style={{
              background: T.hover, border: `1px solid ${T.borderMid}`, borderRadius: 8,
              padding: "7px 12px", color: T.t1, fontSize: 12, flex: 1, outline: "none"
            }} />
          {["all", "ok", "low", "critical", "watch"].map(f => (
            <button key={f} onClick={() => setFilter(f)}
              style={{
                background: filter === f ? T.active : T.hover,
              ...
              {filtered.map(s => (
                <tr key={s.item} style={{ borderBottom: `1px solid ${T.border}` }}>
                  ...
                  <td style={{ padding: "10px 12px" }}>
                    <button style={{
                      background: T.hover, color: T.t2, border: `1px solid ${T.border}`,
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "3fr 1fr", gap: 14, marginBottom: 14 }}>
            ...
            <tbody>
              {transactions.map(t => (
                <tr key={t.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                  ...
                  <td style={{
                    padding: "10px 12px", color: t.type === "income" ? T.green : T.red,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <Card style={{ flex: 1 }}>
            <div style={{
              color: T.t2, fontSize: 11, fontWeight: 600, letterSpacing: "0.05em",
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
        {["directory", "payroll", "departments"].map(t => (
          <button key={t} onClick={() => setTab(t)}
            style={{
              background: tab === t ? T.gold : T.hover, color: tab === t ? "#000" : T.t2,
                ...
                <tr key={e.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                  ...
                  <td style={{ padding: "10px 12px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
                      <div style={{
                        width: 30, height: 30, borderRadius: "50%", background: T.goldBg,
              ...
              {employees.map(e => {
                ...
                return (
                  <tr key={e.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                    ...
                    <td style={{ padding: "10px 12px" }}>
                      <span style={{
                        background: T.greenBg, color: T.green, fontSize: 10, fontWeight: 700,
            ...
            return (
              <Card key={d}>
                ...
                <div style={{ background: T.border, borderRadius: 4, height: 5 }}>
                  <div style={{
                    width: `${Math.round((here / staff.length) * 100)}%`,
                ...
                <div style={{ marginTop: 12, display: "flex", flexWrap: "wrap", gap: 5 }}>
                  {staff.map(e => (
                    <div key={e.id} style={{
                      width: 28, height: 28, borderRadius: "50%", background: T.hover,
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.8fr", gap: 14 }}>
        <Card>
          ...
          <input value={clockInName} onChange={e => setClockInName(e.target.value)}
            ...
            style={{
              width: "100%", background: T.hover, border: `1px solid ${T.borderMid}`,
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 16 }}>
            ...
            <button style={{
              background: T.redBg, color: T.red, border: `1px solid ${T.red}40`,
              borderRadius: 8, padding: "9px", fontSize: 12, fontWeight: 700, cursor: "pointer"
            }}>
              ✕ Clock Out
            </button>
                ...
                <tr key={e.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                  <td style={{ padding: "10px 12px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{
                        width: 26, height: 26, borderRadius: "50%", background: T.hover,
                        border: `1px solid ${T.border}`, display: "flex", alignItems: "center",
            ...
            <tr key={r.id} style={{ borderBottom: `1px solid ${T.border}` }}>
              ...
              <td style={{ padding: "11px 12px" }}>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
                  {(ACCESS[r.id] || []).map(m => (
                    <span key={m} style={{
                      background: T.hover, color: T.t2, fontSize: 10,
...
export default function AppOriginal() {
  ...
  return (
    <div style={{
      display: "flex", height: 800, background: T.bg,
      ...
      {/* ── SIDEBAR ── */}
      <div style={{
        width: 222, background: T.sidebar, borderRight: `1px solid ${T.border}`,
        ...
        <div style={{ padding: "18px 20px 16px", borderBottom: `1px solid ${T.border}`, flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 11 }}>
            <div style={{
              width: 34, height: 34, background: `linear-gradient(135deg, ${T.gold}, #e07700)`,
              borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center",
              fontWeight: 900, fontSize: 16, color: "#000", flexShrink: 0, letterSpacing: "-0.03em"
            }}>P</div>
            <div>
          ...
          {navGroups.map(grp => {
            ...
            return (
              <div key={grp} style={{ marginBottom: 6 }}>
                <div style={{
                  padding: "6px 20px 4px", color: T.t3, fontSize: 9,
        ...
        <div style={{ padding: "12px 20px", borderTop: `1px solid ${T.border}`, flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                color: T.t1, fontSize: 11, fontWeight: 700, whiteSpace: "nowrap",
                overflow: "hidden", textOverflow: "ellipsis"
              }}>{currentRole?.label}</div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
        ...
        {/* Top bar */}
        <div style={{
          height: 54, background: T.card, borderBottom: `1px solid ${T.border}`,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 5, color: T.t2, fontSize: 11 }}>
            ...
            <Link to="/" className="underline">New Template</Link>
          </div>
          ...
          <div style={{ position: "relative" }} onClick={e => e.stopPropagation()}>
            ...
            {notifOpen && (
              <div style={{
                position: "absolute", top: 42, right: 0, width: 320, background: T.card,
          ...
          <div style={{ position: "relative" }} onClick={e => e.stopPropagation()}>
            <button onClick={() => { setRoleOpen(!roleOpen); setNotifOpen(false); }}
              style={{
                display: "flex", alignItems: "center", gap: 8, background: T.hover,
            ...
            {roleOpen && (
              <div style={{
                position: "absolute", top: 42, right: 0, width: 230, background: T.card,
                border: `1px solid ${T.border}`, borderRadius: 10,
                boxShadow: "0 12px 28px rgba(0,0,0,0.5)", zIndex: 200, padding: "6px 0"
              }}>
                <div style={{
                  padding: "6px 14px 8px", color: T.t3, fontSize: 9, fontWeight: 800,
